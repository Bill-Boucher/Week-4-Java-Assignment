...
public class Week4App {
	...
	public static void main(String[] args) {
		...
		employeeNames.add("Wayne");
		employeeNames.add("Kirsten");
		employeeNames.add("Terrell");
		employeeNames.add("Larry");
		ids.add(119);
		ids.add(212);
		ids.add(303);
		ids.add(427);
		...
		//iteration, and a value that is the employeeName at position i of the employeeNames ArrayList. 
		...
		//6.	Once the employeeMap is fully populated, use another enhanced for loop to iterate 
		//over the employeeMap.keySet(), and use the key for each current iteration to print to the 
